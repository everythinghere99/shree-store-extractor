...
// =========================================================
//
// Used only for generating copy-paste product code.
// This does NOT need GITHUB_TOKEN because the website repo
// is public.
//
// =========================================================
...
// =========================================================
//
// ONLY SHREE-P numbers are considered.
...
function findNextShreeProductId(script) {
    ...
    // More flexible closing detection.
    // Handles:
    // ];
    // ];
    // with spaces/comments around it.
    const afterStart =
        script.slice(
            affiliateStart
        );
...
// =========================================================
// Get script.js From GitHub Contents API
// =========================================================
//
// Used by direct GitHub update.
...
// =========================================================
// Read Public script.js For Copy Code
// =========================================================
//
// IMPORTANT:
// This endpoint does not require GITHUB_TOKEN.
//
// =========================================================
...
async function getPublicGitHubScript() {
    ...
    if (
        ...
        throw new Error(
            'Unable to read public script.js